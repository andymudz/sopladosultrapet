  ...
  <div class="container">
        ...
        <div class="container-nav">
          <nav>
            <ul>
              ...
              <li><a href="#productos" class="item i1">Productos <span></span> </a></li>
    ...
    <div class="container-all">
      <div class="container-redes">
          <a href="" class="it1"><i class="fab fa-facebook-square"><P class="face1">FACEBOOK</P></i></a>
          <a href="" class="it2"><i class="fab fa-instagram"><P class="face2">INSTAGRAM</P></i></a>
      </div>
      <div class="cover">
        <!-- inicio wave-->
